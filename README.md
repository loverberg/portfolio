...
| :--------------- | :------- | :------------------- | :----- |
|Hive Star Schema Data Mart| Создание витрины данных с использованием инфраструктуры Hadoop (Hive) в облачном решении Yandex.Cloud| `S3` `HDFS` `HIVE` `MapReduce` `TEZ` `YARN` `HiveSQL` `CLI` `Shell` `Hadoop Cluster Administration` `Cloud`| [DataEngineer.Hive][7]|
